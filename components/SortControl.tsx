...
export function SortControl({ value, onChange, effectiveSort }: Props) {
  return (
    <div className="flex flex-wrap items-center justify-end gap-2 rounded-lg bg-white px-4 py-2 text-sm shadow-sm">
